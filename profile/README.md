...
6. [KMIR](https://github.com/runtimeverification/mir-semantics): A formal semantics of the Rust MIR (Mid-level Intermediate Representation) in the K framework.
